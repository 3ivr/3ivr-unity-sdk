        ...
        protected Ray GetRay()
        {
            ...
            switch (raycastMode)
            {
                case RaycastMode.Camera:
                    ...
                    Vector3 cameraLocation = I3vrControllerManager.MainCamera.transform.position;
                    Vector3 finalRayDirection = rayPointerEnd - cameraLocation;
                    finalRayDirection.Normalize();

                    Vector3 finalRayStart = cameraLocation + (finalRayDirection * I3vrControllerManager.MainCamera.nearClipPlane);
