...
namespace i3vr
{
    /// This class is used by _I3vrPointerInputModule_ to route scroll events through Unity's Event System.
    ...
    [System.Serializable]
    public class I3vrPointerScrollInput
    {
          ...
          bool isPointerActiveAndAvailable)
        {
            ...
            touchDown |= I3vrControllerManager.RightController.TouchDown;
            touching |= I3vrControllerManager.RightController.IsTouching;
            touchUp |= I3vrControllerManager.RightController.TouchUp;
            currentScroll = I3vrControllerManager.RightController.TouchPos * SCROLL_DELTA_MULTIPLIER;
